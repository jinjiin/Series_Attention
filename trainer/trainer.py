...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        for batch_idx, (pm25, pm10, pm25_target, pm10_target) in enumerate(self.data_loader):
            ...
            pm25_predict, pm10_predict = self.model(pm25, pm10)
            ...
            pm25_metrics = self.metrics(pm25_predict, pm25_target)
    ...
    def _valid_epoch(self, epoch):
        ...
        with torch.no_grad():
            for batch_idx, (pm25, pm10, pm25_target, pm10_target) in enumerate(self.valid_loader):
                pm25, pm10, pm25_target, pm10_target = pm25.to(self.device), pm10.to(self.device), \
                                                       pm25_target.to(self.device), pm10_target.to(self.device)
                pm25_predict, pm10_predict = self.model(pm25, pm10)
        ...
        return {
            ...
            'val_rmse_loss': np.sqrt(total_loss / length)
        }
