...
class BaseDataset(data.Dataset):
    ...
    #     embedding_entity = torch.Tensor(embedding_entity)  # .cuda()
    ...
    #     return torch.Tensor(pm25_feature), torch.Tensor(pm10_feature), torch.Tensor(pm25_target), torch.Tensor(pm10_target)
